...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting Faq processing");
    
    let mut processor = FaqProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = FaqProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = FaqProcessor::new(false);
